...
for bz in range(0,33):
    ...
    E1_data = np.load(f"final_results/two_state_fits/Pz{P0}/E1_fits_Pz{P0}.npy")
    E0 = np.sqrt((0.139)**2 + phys_p(a,P0)**2)/a
    E1 = E1_data[0,bestE1_tmins[P0]-2]
    Z0 = np.sqrt(2*E0*E1_data[2,bestE1_tmins[P0]-2])
    Z1 = np.sqrt(2*E1*E1_data[4,bestE1_tmins[P0]-2])
...
# repeat jackknife procedure for 
