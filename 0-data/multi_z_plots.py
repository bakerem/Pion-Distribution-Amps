...
for Pz in range(4,10):
    ...
    real_fit = real_state2ratio(15,fits[f"Pz = {Pz}"][1,:], fits[f"Pz = {Pz}"][3,:])
    imag_fit = imag_state2ratio(15,fits[f"Pz = {Pz}"][6,:], fits[f"Pz = {Pz}"][8,:])
    real_fit_err =np.abs(real_state2ratio(15,
                                    fits[f"Pz = {Pz}"][1,:]+np.sqrt(fits[f"Pz = {Pz}"][2,:]), 
                                    fits[f"Pz = {Pz}"][3,:]+np.sqrt(fits[f"Pz = {Pz}"][4,:])) \
                 - real_fit)
    imag_fit_err =np.abs(imag_state2ratio(15,
