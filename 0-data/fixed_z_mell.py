    ...
    for init_char in ["Z5","T5"]:
        ...
        for bz in range(2,8):
            ...
            def ratio_m(Pz_range, mm2, mm4, ):
                num   = m_ope(bz/a, mm2, mm4, 0, 0, 0, 0, 0, 2*N_max, Nh, phys_p(a,Pz_range), init_char)
        ...
        if save:
            ...
            os.makedirs(save_path, exist_ok=True)
            plt.savefig(f"{save_path}/fixed_z_mm2.pdf")
        # plt.show()
