...
infos  = []
data2_Z5 = np.zeros((12,3))
data4_Z5 = np.zeros((12,3))
data2_T5 = np.zeros((12,3))
data4_T5 = np.zeros((12,3))
index = 0
for Nh in range(0,2):
    for Nl in range(0,2):
        for N_max in range(2,5):
            ...
            infos.append(info)
            data2_Z5[index] = np.array((np.average(samples2_Z5), np.sqrt(len(moms2_Z5)-1)*np.std(samples2_Z5), np.average(sample_errs2_Z5)))
            data4_Z5[index] = np.array((np.average(samples4_Z5), np.sqrt(len(moms4_Z5)-1)*np.std(samples4_Z5), np.average(sample_errs4_Z5)))
            data2_T5[index] = np.array((np.average(samples2_T5), np.sqrt(len(moms2_T5)-1)*np.std(samples2_T5), np.average(sample_errs2_T5)))
            data4_T5[index] = np.array((np.average(samples4_T5), np.sqrt(len(moms4_T5)-1)*np.std(samples4_T5), np.average(sample_errs4_T5)))
            index +=1
...
plt.tick_params(
    ...
    labelleft=False) 
if save:
    plt.savefig(f"{save_path}/Z5mellin2.png")
plt.show()
...
plt.tick_params(
    ...
    labelleft=False) 
if save:
    plt.savefig(f"{save_path}/T5mellin2.png")
plt.show()
...
plt.tick_params(
    ...
    labelleft=False) 
if save:
    plt.savefig(f"{save_path}/Z5mellin4.png")
plt.show()
...
plt.tick_params(
    ...
    labelleft=False) 
if save:
    plt.savefig(f"{save_path}/T5mellin4.png")
plt.show()
