    ...
    for Pz in range(4,10):
        ...
        if i == "Z5":
            ...
            line2 = plt.errorbar(Pz,
                        -Z0*imag_fit/prefactor[i],
                        yerr=Z0*imag_fit_err/prefactor[i], 
                        fmt="rs", 
                        label=f"Pz = {Pz}",
                        capsize=4)

plt.xlabel("$P_z$")
plt.ylabel(r"$f_\pi$ (GeV)")
plt.title(r"Calculation of $f_{\pi}$")
# plt.hlines(0.134, xmin=4, xmax=9, colors="gray", linestyles="dashed")
