                ...
                for Pz_min in range(Pz_min_low, Pz_min_up):
                    for Pz_max in range(Pz_max_low, Pz_max_up):
                        ...
                        def ratio(bzPz, an2, an4, ):
                            bz, Pz = bzPz_range
                            num   = c_ope(bz/a, an2, an4, 0, 0, 0, 0, 0, 2*N_max, Nh, phys_p(a,Pz), 0, init_char)
                            denom = c_ope(bz/a, an2, an4, 0, 0, 0, 0, 0, 2*N_max, Nh, phys_p(a,P0), 0, init_char)
                        ...
                        if save:
                            ...
                            # np.save(f"{save_path}/tree_moms6_Nmax{N_max}_h{Nh}_l{Nl}.npy",moms6)
                            # np.save(f"{save_path}/tree_moms6_err_Nmax{N_max}_h{Nh}_l{Nl}.npy", moms6_err)
                            # np.save(f"{save_path}/tree_moms8_Nmax{N_max}_h{Nh}_l{Nl}.npy",moms8)
                            # np.save(f"{save_path}/tree_moms8_err_Nmax{N_max}_h{Nh}_l{Nl}.npy", moms8_err)
